...
export default function DebatePage({ params }) {
    ...
    setArgumentsList((prev) =>
      prev.map((arg) =>
        arg.id === argumentId
          ? {
              ...arg,
              votes: arg.userVoted ? arg.votes - 1 : arg.votes + 1,
              userVoted: !arg.userVoted,
            }
          : arg
      )
    );
  ...
  const supportArguments = argumentsList.filter(
  ...
  return (
    <div className="">
      {/* Header */}
      <div className="relative py-40 bg-secondary-bg">
        {debate.image && (
          <Image
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="font-medium text-text-lite">
                        {debate.author.name}
                      </span>
                    </div>
                  </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-text-lite">
                      {debate.participants}
                    </span>
                  </div>
                  <div className="flex justify-between">
        ...
        {!debate.userHasJoined ? (
          <div className="bg-background rounded-lg shadow-sm border border-border mb-8">
            <div className="p-6 text-center">
              <h3 className="text-xl font-semibold text-text-lite mb-4">
                Join the Debate
              </h3>
          ...
          <div className="bg-background rounded-lg shadow-sm border border-border mb-8">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-text-lite mb-2">
                Post Your Argument -{" "}
                {debate.userSide === "support" ? "Supporting" : "Opposing"}
              </h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-text-lite">
            ...
            <div className="space-y-4">
              ...
              {supportArguments.length === 0 && (
                <div className="bg-background rounded-lg shadow-sm border border-border p-6 text-center text-text-dark">
                  No supporting arguments yet. Be the first to support this
                  debate!
                </div>
              )}
            </div>
